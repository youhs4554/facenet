...
from pyfeat_benchmark_disfa_runner import run_disfa_benchmark, write_disfa_report
from pyfeat_benchmark_runner import run_aflfp_benchmark, write_aflfp_report
...
def build_parser() -> argparse.ArgumentParser:
    ...
    run_parser = subparsers.add_parser("run", help="Run a deterministic accuracy pilot")
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.dataset == "aflfp":
        ...
        json_path, markdown_path = write_aflfp_report(report, args.output_dir)
    else:
        ...
        json_path, markdown_path = write_disfa_report(report, args.output_dir)
