...
\centering
\small
\input{generated/headline_table}
\end{table*}
...
\centering
\footnotesize
\input{generated/aflfp_movement_table}
\end{table*}
...
\Cref{fig:disfa-prevalence} relates positive prevalence to F1. Across the 12
AUs the descriptive Pearson correlation is
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.90\textwidth]{figures/disfa_prevalence_f1.pdf}
\caption{DISFA positive prevalence versus F1. Marker area increases with
positive support. The plot shows class imbalance retained by uniform temporal
sampling; it is descriptive over 12 AUs and no significance test is claimed.}
\label{fig:disfa-prevalence}
\end{figure*}
...
\centering
\small
\input{generated/disfa_au_table}
\end{table*}
...
not establish safety or diagnostic utility for facial palsy.
...
all derived assets, and compiles the manuscript. Raw AFLFP and DISFA media are
excluded because access and redistribution are governed by their respective
dataset terms. No participant images are reproduced in this paper, and no new
